...
export function rowToContent(row, memories = [], galleryItems = [], wishlistItems = []) {
  ...
  return {
    ...
    login: {
      eyebrow: row.login_eyebrow ?? '',
      title: row.login_title ?? '',
      subtitle: row.login_subtitle ?? '',
      placeholder: row.login_placeholder ?? '',
      passwordLabel: row.login_password_label ?? '',
      button: row.login_button ?? '',
      error: row.login_error ?? '',
      footer: row.login_footer ?? '',
    },
    welcome: {
      eyebrow: row.welcome_eyebrow ?? '',
      title: row.welcome_title ?? '',
      subtitle: row.welcome_subtitle ?? '',
    ...
    story: {
      ...
      firstMeeting: {
        label: row.story_first_meeting_label ?? '',
        description: row.story_first_meeting_description ?? '',
      },
      loveConfession: {
        label: row.story_love_confession_label ?? '',
        message: row.story_love_confession_message ?? '',
      },
      memoriesButton: storyMemoriesButton || row.story_memories_button || '',
    },
    gallery: {
      eyebrow: row.gallery_eyebrow ?? '',
      title: row.gallery_title ?? '',
      finalButton: galleryFinalButton || row.gallery_final_button || '',
    },
    countdownsNextButton: countdownsNextButton || '',
    final: {
      eyebrow: row.final_eyebrow ?? '',
