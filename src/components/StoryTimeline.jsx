  ...
  return (
    <>
      <RevealItem as="div" role="listitem" className="mx-auto w-full max-w-lg">
        <article className="group relative overflow-hidden rounded-3xl border border-rose-100 dark:border-rose-800/50 bg-white/90 dark:bg-slate-900/90 p-6 sm:p-7 shadow-xl shadow-rose-900/5 dark:shadow-rose-950/30 backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-rose-300/20 dark:hover:shadow-rose-900/30 text-center">
          {/* Ambient Glow */}
          <div className="pointer-events-none absolute -right-10 -top-10 h-36 w-36 rounded-full bg-gradient-to-br from-rose-200/35 to-pink-100/25 dark:from-rose-600/15 dark:to-pink-900/10 blur-2xl transition-all duration-500 group-hover:scale-150" />

          <RomanticDateBadge date={date} className="mb-4" />

          <div className="inline-flex items-center justify-center gap-2 rounded-2xl bg-rose-50/90 dark:bg-rose-900/40 px-4 py-1.5 text-sm font-bold text-rose-900 dark:text-rose-200 border border-rose-100/80 dark:border-rose-700/50 mb-3.5 shadow-xs">
            <Sparkles size={15} className="text-rose-500 dark:text-rose-400" />
            <span className="font-display">{label}</span>
          </div>

          <div className="text-sm sm:text-base leading-relaxed text-rose-800/90 dark:text-rose-200/90 font-medium">
            {children}
          </div>
        </article>
      </RevealItem>
...
export function TimelineLoveConfession({
  ...
  return (
    <>
      <RevealItem as="div" role="listitem" className="mx-auto w-full max-w-lg">
        <article className="group relative overflow-hidden rounded-3xl border border-rose-200/80 dark:border-rose-700/50 bg-gradient-to-b from-white to-rose-50/40 dark:from-slate-900 dark:to-slate-800/80 p-6 sm:p-7 shadow-xl shadow-rose-900/5 dark:shadow-rose-950/30 backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-rose-300/25 dark:hover:shadow-rose-900/30 text-center">
          <div className="pointer-events-none absolute -left-10 -bottom-10 h-36 w-36 rounded-full bg-gradient-to-tr from-rose-300/30 to-pink-200/20 dark:from-rose-600/15 dark:to-pink-900/10 blur-2xl transition-all duration-500 group-hover:scale-150" />
          ...
          <p className="text-sm sm:text-base leading-relaxed text-rose-900 dark:text-rose-200 font-medium">
            {message}
          </p>
        </article>
      </RevealItem>
